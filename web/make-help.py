...
parts.append('<h2 id="h-version">About this version</h2><ul>'
             '<li>Based on <strong>Advanced Rogue 7.7.1</strong> (Michael Morgan, Ken Dalka).</li>'
             '<li>Original source: <a href="https://github.com/RoguelikeRestorationProject/arogue7.7/tree/976b5bb" target="_blank" rel="noopener">RoguelikeRestorationProject/arogue7.7, commit 976b5bb</a></li>'
             '<li>Our changes (port, auto-explore, command menu, web build): '
             '<a href="https://github.com/memmaker/arogue7.7/compare/976b5bb...master" target="_blank" rel="noopener">memmaker/arogue7.7, compared with the original</a></li></ul>')
print('\n'.join(parts))
