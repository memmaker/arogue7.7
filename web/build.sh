#!/bin/sh
# Build Advanced Rogue 7.7 for the browser (Emscripten + Asyncify) into web/dist;
...
cp web/index.html "$HOME/Games/rvip-tools/web/rvip-wm.js" web/arogue77.js port/tiles.png port/tiles-dawn.png "$OUT/"
